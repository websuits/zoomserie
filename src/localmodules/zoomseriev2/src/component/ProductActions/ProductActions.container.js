...
/** @namespace Zoomseriev2/Component/ProductActions/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    groupedProductQuantity: state.ProductReducer.groupedProductQuantity,
    device: state.ConfigReducer.device
});

/** @namespace Zoomseriev2/Component/ProductActions/Container/ProductActionsContainer */
...
/** @namespace Zoomseriev2/Component/ProductActions/Container/mapDispatchToProps */
