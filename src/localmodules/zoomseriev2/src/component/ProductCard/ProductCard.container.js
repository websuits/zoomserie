...
/** @namespace Zoomseriev2/Component/ProductCard/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    device: state.ConfigReducer.device
});

/** @namespace Zoomseriev2/Component/ProductCard/Container/mapDispatchToProps */
...
/** @namespace Zoomseriev2/Component/ProductCard/Container/ProductCardContainer */
