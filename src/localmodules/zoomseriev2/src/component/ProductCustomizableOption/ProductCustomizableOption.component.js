...
/** @namespace Zoomseriev2/Component/ProductCustomizableOption/Component/ProductCustomizableOptionComponent */
export class ProductCustomizableOptionComponent extends SrcProductCustomizableOption {
    ...
    renderTextField() {
        ...
        return (
            <>
                ...
                />
                { this.renderCustomPriceLabel(priceLabel) }
                { this.renderRequired(required) }
    ...
    renderCustomPriceLabel(titleBold) {
        return (
            <span
              block="ProductCustomizableOptions"
