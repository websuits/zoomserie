...
import { CartItem as SrcCartItem } from 'SourceComponent/CartItem/CartItem.component';
 ...
 * @class CartItem
 * @namespace Zoomseriev451/Component/CartItem/Component/CartItemComponent */
export class CartItemComponent extends SrcCartItem {
    static propTypes = {
    ...
    renderWrapperContent() {
        return (
            <figure block="CartItem" elem="Options">
                { this.renderImage() }
                { this.renderContent() }
            </figure>
        );
    ...
    renderWrapperOptions() {
        ...
        return (
            <div block="CartItem" elem="Options-Elements">
