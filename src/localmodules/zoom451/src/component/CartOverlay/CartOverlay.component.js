...
import { CartOverlay as SrcCartOverlay } from 'SourceComponent/CartOverlay/CartOverlay.component';
...
/** @namespace Zoom451/Component/CartOverlay/Component/CartOverlayComponent */
export class CartOverlayComponent extends SrcCartOverlay {
    static propTypes = {
    ...
    renderSecureCheckoutButton() {
        const { totals, handleCheckoutClick, hasOutOfStockProductsInCart } = this.props;
