...
import { CheckoutOrderSummary as SrcCheckoutOrderSummary } from 'SourceComponent/CheckoutOrderSummary/CheckoutOrderSummary.component';
 ...
 * @namespace Zoom451/Component/CheckoutOrderSummary/Component/CheckoutOrderSummaryComponent */
export class CheckoutOrderSummaryComponent extends SrcCheckoutOrderSummary {
    static propTypes = {
        totals: TotalsType,
    ...
    renderContent() {
        ...
        return (
            <>
                <CmsBlock identifier="delivery_area_block" />
                { this.renderHeading() }
                { this.renderItems() }
                { this.renderTotals() }
            </>
