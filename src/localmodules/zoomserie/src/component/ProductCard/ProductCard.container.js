...
/** @namespace Zoomserie/Component/ProductCard/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    device: state.ConfigReducer.device
});

/** @namespace Zoomserie/Component/ProductCard/Container/mapDispatchToProps */
...
/** @namespace Zoomserie/Component/ProductCard/Container/ProductCardContainer */
