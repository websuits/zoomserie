...
/** @namespace Zoomserie/Component/ProductActions/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    groupedProductQuantity: state.ProductReducer.groupedProductQuantity,
    device: state.ConfigReducer.device
});

/** @namespace Zoomserie/Component/ProductActions/Container/ProductActionsContainer */
...
/** @namespace Zoomserie/Component/ProductActions/Container/mapDispatchToProps */
