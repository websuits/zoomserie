...
/** @namespace Zoomserie/Route/HomePage/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    pageIdentifiers: state.ConfigReducer.cms_home_page,
    currentStoreCode: state.ConfigReducer.code
});

/** @namespace Zoomserie/Route/HomePage/Container/mapDispatchToProps */
export const mapDispatchToProps = (dispatch) => ({
    // eslint-disable-next-line no-undef
    changeHeaderState: (state) => dispatch(changeNavigationState(TOP_NAVIGATION_TYPE, state))
});

/** @namespace Zoomserie/Route/HomePage/Container/HomePageContainer */
export class HomePageContainer extends SrcHomePage {
    ...
    render() {
        ...
        const Level3ItemsBv = (
            <div className="level3">
                <Accordion.Title href="https://coresi.magstart.ro">Coresi Brașov</Accordion.Title>
